...
export async function getLegacyMessages(
	conversationId: string,
): Promise<LegacyMessage[]> {
	return await invoke<LegacyMessage[]>("db_get_messages", {
		conversationId,
...
export async function getMessages(conversationId: string): Promise<any[]> {
	return await invoke<any[]>("db_get_ai_messages", {
		conversationId,
		conversation_id: conversationId,
	});
}
...
export async function addLegacyMessage(
	...
	return await invoke<LegacyMessage>("db_add_message", {
		input: { conversation_id: conversationId, role, content },
	});
}
...
export async function updateConversationTitle(
	...
	return await invoke<Conversation>("db_update_conversation_title", {
		id,
		title,
	});
}
...
export async function generateConversationTitle(
	...
	return await invoke<Conversation>("generate_conversation_title", {
		input: { conversation_id: id, model },
	});
}
...
export async function saveCompleteMessage(
	conversationId: string,
	message: any,
): Promise<void> {
	await invoke("db_save_complete_message", {
