...
export default function authKeyTab() {
  ...
  async function onSelfhostSubmit(data: z.infer<typeof SelfHostFormSchema>) {
    try {
      await invoke("save_settings", { apiKey: data.apiKey, apiUrl: data.apiUrl });
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          This is your Tethra API key. get it from <a href="https://tethra.decentparadox.me/dashboard" target="_blank" className="text-blue-700">here</a>
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="https://api.tethra.com" {...field} />
                        </FormControl>
                        <FormDescription>
