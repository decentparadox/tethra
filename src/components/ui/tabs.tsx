...
function Tabs({
  ...
  return (
    <TabsPrimitive.Root
      data-slot="tabs"
      className={cn("flex flex-col w-full gap-2 justify-center items-center sm:items-start", className)}
      {...props}
    />
  )
}
...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-muted text-muted-foreground inline-flex h-9 w-fit items-start justify-start rounded-lg p-[3px]",
        className
      )}
      {...props}
    />
